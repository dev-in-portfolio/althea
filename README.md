...
Exhibit Forge is a Django + Neon exhibit builder with ordered cards, publishing, and public share pages.
...
5. Start server: `python manage.py runserver 0.0.0.0:8012`
