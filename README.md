...
LineFlow is a multi-timer command board backend for Neon Postgres.
...
The API will be available at `http://127.0.0.1:3014`.

## API overview

- `GET /api/timers/health`
- `GET /api/timers/status`
- `GET /api/timers/presets`
- `POST /api/timers/presets`
- `DELETE /api/timers/presets/:id`
- `GET /api/timers/sessions`
- `POST /api/timers/sessions`
- `PATCH /api/timers/sessions/:id`
