...
QueueGauge is a lightweight relational job queue backend built with NestJS and Neon.
Clients authenticate via `X-Device-Key`.
...
The API will be available at `http://127.0.0.1:3018`.
