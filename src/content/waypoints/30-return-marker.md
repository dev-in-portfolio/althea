...
mood: "focused"
order: 30
excerpt: "Choose a simple sign that tells you when to return."
---
Pick a marker—two blocks, a tree, a storefront. When you reach it, turn around or pause.

The marker makes the walk manageable. It turns the route into a loop you can trust.

Try this: name the marker out loud the first time you reach it.
