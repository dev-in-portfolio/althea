...
mood: "bright"
order: 14
excerpt: "Look up and let the sky set your breathing tempo."
---
Pick a cloud or a patch of blue. Match your inhale to its shape, your exhale to its drift. The sky is a slow clock.

If clouds are moving quickly, choose the nearest still object—an antenna, a rooftop, a treetop—and let its stability guide you.

Carry that spaciousness back down to your steps.

Try this: take three steps while looking up, then three steps looking forward. Feel the change in your pace.

Reflection: the sky asks you to lift your attention. When you lift your gaze, your breath often follows. This is a subtle form of relief.

If you feel compressed by the day, the sky is a counterweight. It reminds you there is always more room than you think.

On overcast days, look for texture—layers, movement, shifts in gray. The sky still speaks; it just whispers.

Try this: choose a single point in the sky and return to it every few minutes. It becomes a steady reference for your pace.

## Extended Walk

This waypoint is a prompt with a bright tone. Let it set a open and attentive pace: the goal is not speed, but steadiness. Begin by standing where you can see a doorway, a corner, and a quiet wall. name the smallest details first, then widen your view. Anchor your attention on your feet and the edge of your breath. Let that anchor be the thread you return to when your mind wanders.
