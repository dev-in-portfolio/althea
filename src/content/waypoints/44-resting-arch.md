...
mood: "tender"
order: 44
excerpt: "Find a place that feels like a soft arch and rest there."
---
It might be a doorway, a tree canopy, or a hallway bend. Stand beneath it for a moment.

Let the shape overhead tell your body it can soften.

Try this: raise your arms briefly as if you were tracing the arch, then release.

## Extended Walk

This waypoint is a prompt with a tender tone. Let it set a soft and deliberate pace: the goal is not speed, but steadiness. Begin by standing where you can see a lane, a stair, and a pocket of sky. notice the smallest details first, then widen your view. Anchor your attention on the weight of your gaze and the ground beneath it. Let that anchor be the thread you return to when your mind wanders.
