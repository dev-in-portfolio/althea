...
mood: "curious"
order: 33
excerpt: "Let the sound of your steps set your tempo."
---
Listen to the echo of your footsteps. Let their rhythm decide your pace.

If the echo is fast, slow down until it softens. If it is quiet, notice how calm it feels.

Try this: count ten echoes, then begin the count again.

## Extended Walk

This waypoint is a tool with a curious tone. Let it set a open and attentive pace: the goal is not speed, but steadiness. Begin by standing where you can see a doorway, a corner, and a quiet wall. name the smallest details first, then widen your view. Anchor your attention on your feet and the edge of your breath. Let that anchor be the thread you return to when your mind wanders.
