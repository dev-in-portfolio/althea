...
mood: "tender"
order: 51
excerpt: "Turn gently and notice how it changes the walk."
---
When you turn a corner, do it slowly. Let the new scene arrive in full.

A soft turn creates a softer mind.

Try this: take one breath before turning and one after.

## Extended Walk

This waypoint is a prompt with a tender tone. Let it set a patient and grounded pace: the goal is not speed, but steadiness. Begin by standing where you can see a threshold, a curb, and a window. map the smallest details first, then widen your view. Anchor your attention on the way your hands rest and the softest nearby sound. Let that anchor be the thread you return to when your mind wanders.
