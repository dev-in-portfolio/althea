...
mood: "bright"
order: 34
excerpt: "Invite fresh air into the walk and into the day."
---
Open a window or pass an open doorway. Let the air shift your attention.

Notice the difference in temperature, scent, or sound. The change is a small reset.

Try this: breathe in the new air for three counts and let it set your pace.

## Extended Walk

This waypoint is a prompt with a bright tone. Let it set a patient and grounded pace: the goal is not speed, but steadiness. Begin by standing where you can see a threshold, a curb, and a window. map the smallest details first, then widen your view. Anchor your attention on the way your hands rest and the softest nearby sound. Let that anchor be the thread you return to when your mind wanders.
