...
mood: "grounded"
order: 45
excerpt: "A small mental map for the quiet hours."
---
Name three points: a light, a shadow, and a safe place. Let them anchor you.

If you are indoors, choose three corners of the room.

Try this: walk between the three points slowly and return to the first.

## Extended Walk

This waypoint is a tool with a grounded tone. Let it set a soft and deliberate pace: the goal is not speed, but steadiness. Begin by standing where you can see a lane, a stair, and a pocket of sky. notice the smallest details first, then widen your view. Anchor your attention on the weight of your gaze and the ground beneath it. Let that anchor be the thread you return to when your mind wanders.
