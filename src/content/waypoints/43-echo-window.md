...
mood: "curious"
order: 43
excerpt: "Notice a window and listen for the sounds it holds."
---
Pause near a window and listen: inside sounds, outside sounds, your own breath.

Let the window be a frame for listening.

Try this: count three sounds and move on.

## Extended Walk

This waypoint is a prompt with a curious tone. Let it set a open and attentive pace: the goal is not speed, but steadiness. Begin by standing where you can see a doorway, a corner, and a quiet wall. name the smallest details first, then widen your view. Anchor your attention on your feet and the edge of your breath. Let that anchor be the thread you return to when your mind wanders.
