...
mood: "calm"
order: 31
excerpt: "Choose a short span and walk it as if it were longer."
---
Select a small stretch—one block, one hallway, one room. Walk it as if it were a long road, with full attention.

Slow your steps slightly and notice details you would normally miss.

Try this: repeat the span twice and see if it feels different the second time.
