...
mood: "bright"
order: 22
excerpt: "A short exercise for closing one open loop."
---
Write down one lingering task. Choose the next smallest action. Do only that, then walk for five minutes to let the closure land.

If the task is too large, split it until you find a step that feels simple. The walk is part of the completion.

Notice how it feels to move with one loop closed.

Try this: say “complete” aloud when you finish the step. Let the word mark the moment.

Reflection: open loops create background noise. Closing even one reduces the volume. The walk becomes clearer.

If you cannot close a loop today, define the next action. That often provides the same relief as completion.

Treat the walk as the hinge between the action and the relief. Let your body register the shift.

Try this: after the walk, write a single line about how it felt to close the loop. This builds trust in the practice.

## Extended Walk

This waypoint is a tool with a bright tone. Let it set a slow and steady pace: the goal is not speed, but steadiness. Begin by standing where you can see a bench, a shadow, and a small gap between sounds. trace the smallest details first, then widen your view. Anchor your attention on the line of your shoulders and the air around you. Let that anchor be the thread you return to when your mind wanders.
