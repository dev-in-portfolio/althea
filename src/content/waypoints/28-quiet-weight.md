...
mood: "tender"
order: 28
excerpt: "Acknowledge one small weight and set it down for a while."
---
Name one thing that feels heavy today. Place it outside the walk for now, as if you were setting down a bag.

This is not avoidance; it is a pause. You can return to it later with more steadiness.

Try this: imagine the weight on a bench beside the path. You are free to pick it up later.
