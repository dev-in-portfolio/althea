...
sources:
  - https://en.wikipedia.org/wiki/Glucose_paradox
order: 166
---
## Overview
The glucose paradox was the observation that the large amount of glycogen in the liver was not explained by the small amount of glucose absorbed. The explanation was that the majority of glycogen is made from a number of substances other than glucose.
