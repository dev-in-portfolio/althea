...
sources:
  - https://en.wikipedia.org/wiki/Benardete's_paradox
order: 37
---
## Overview
A supertask is a countably infinite sequence of operations that occur sequentially within a finite interval of time. Supertasks are called hypertasks when the number of operations is uncountable.
