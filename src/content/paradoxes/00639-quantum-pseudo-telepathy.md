...
slug: "quantum-pseudo-telepathy"
type: THOUGHT_EXPERIMENT
summary: "Quantum pseudo-telepathy describes the use of quantum entanglement to eliminate the need for classical communications. A nonlocal game is said to display quantum pseudo-telepathy if players who can use entanglement can win it with certainty while players without it can not."
tags:
  - physics
  - game-theory
axioms:
...
sources:
  - https://en.wikipedia.org/wiki/Quantum_pseudo_telepathy
order: 639
---
## Overview
Quantum pseudo-telepathy describes the use of quantum entanglement to eliminate the need for classical communications. A nonlocal game is said to display quantum pseudo-telepathy if players who can use entanglement can win it with certainty while players without it can not.
