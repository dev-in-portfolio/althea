...
sources:
  - https://en.wikipedia.org/wiki/Elevator_paradox_(physics)
order: 121
---
## Overview
The elevator paradox relates to a hydrometer placed on an "elevator" or vertical conveyor that, by moving to different elevations, changes the atmospheric pressure. In this classic demonstration, the floating hydrometer remains at an equilibrium position.
