...
---
## Overview
In mathematics, the infinite series 1 − 1 + 1 − 1 + ⋯ is a divergent series, meaning that the sequence of partial sums of the series does not converge. Although it is divergent, it can be manipulated to yield a number of mathematically interesting results.
