...
slug: '00214-intransitive-dice'
type: PARADOX
summary: 'A set of dice is intransitive (or nontransitive) if it contains n > 2 {\\displaystyle n>2} dice, X 1 , X 2 , . .'
tags:
  - set-theory
axioms:
...
---
## Overview
A set of dice is intransitive (or nontransitive) if it contains n > 2 {\displaystyle n>2} dice, X 1 , X 2 , . .
