---
title: 'Voting system'
slug: '00480-voting-system'
type: PARADOX
summary: 'An electoral system is a set of rules and mechanisms used to determine the results of an election. Electoral systems are used in politics to elect governments and also in non-political settings such as business, nonprofit organizations and informal organisations.'
tags:
  - set-theory
axioms:
...
---
## Overview
An electoral system is a set of rules and mechanisms used to determine the results of an election. Electoral systems are used in politics to elect governments and also in non-political settings such as business, nonprofit organizations and informal organisations.
