...
slug: '00430-successor-function'
type: PARADOX
summary: 'In mathematics, the successor function or successor operation sends a natural number to the next one. The successor function is denoted by S {\\displaystyle S} , so S ( n ) = n + 1 {\\displaystyle S(n)=n+1} .'
tags:
  - paradox
axioms:
...
---
## Overview
In mathematics, the successor function or successor operation sends a natural number to the next one. The successor function is denoted by S {\displaystyle S} , so S ( n ) = n + 1 {\displaystyle S(n)=n+1} .
