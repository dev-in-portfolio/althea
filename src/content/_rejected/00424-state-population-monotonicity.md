---
title: 'State-population monotonicity'
slug: '00424-state-population-monotonicity'
type: PARADOX
...
sources:
  - https://en.wikipedia.org/wiki/State-population_monotonicity
order: 424
---
## Overview
Vote-ratio, weight-ratio, or population-ratio monotonicity is a property of some apportionment methods. It says that if the entitlement for A {\displaystyle A} grows at a faster rate than B {\displaystyle B} (i.e.
